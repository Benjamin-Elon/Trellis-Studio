...
Draw.loadPlugin(function (ui) {
    ...
    RoadmapVertexHandler.prototype.updateHint = function () { if (this.hint && this.hint.parentNode) this.hint.parentNode.removeChild(this.hint); this.hint = null; }; // CHANGE: roadmap date hints replace editor width/height hints.
