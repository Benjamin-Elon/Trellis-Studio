...
Draw.loadPlugin(function (ui) {
    ...
    const BROAD_CATALOG_CATEGORIES = [
        ...
        { id: "control_protection", label: "Control & protection", categories: ["backflow", "filter", "regulator", "controller_timer", "valve"] },
        { id: "distribution", label: "Distribution", categories: ["manifold", "fitting", "pipe_tubing", "standpipe"] },
        { id: "application", label: "Water application", categories: ["drip_tape", "dripline", "emitter", "sprinkler", "microspray", "bubbler"] },
        { id: "termination", label: "Termination", categories: ["cap_end"] }
    ];
    ...
    const BED_TEMPLATES = [
        { id: "drip_tape_bed", label: "Drip tape bed", defaultRows: 2, defaultRowOrientation: "width", lineKind: "drip_tape", pipePartId: "poly_distribution_1_2", requiredParts: [{ partId: "drip_tape_8mil_12in", quantityPerRowMeter: 1 }], flowGpm: 1.2, pressurePsi: 10 },
        { id: "dripline_bed", label: "Dripline bed", defaultRows: 2, defaultRowOrientation: "width", lineKind: "dripline", pipePartId: "poly_distribution_1_2", requiredParts: [{ partId: "pc_dripline_1_2", quantityPerRowMeter: 1 }], flowGpm: 1.0, pressurePsi: 12 },
        ...
        { id: "soaker_row", label: "Soaker row", defaultRows: 2, defaultRowOrientation: "width", lineKind: "dripline", pipePartId: "poly_distribution_1_2", requiredParts: [{ partId: "soaker_row_line_1_2", quantityPerRowMeter: 1 }], flowGpm: 0.8, pressurePsi: 10 },
    ...
    const STARTER_CATALOG_ITEMS = [
        starterPart("hose_vacuum_breaker", "3/4 in FGHT x MGHT hose vacuum breaker", "backflow", 12, 1, 1, input("fght", "3/4"), output("mght", "3/4"), { pressureLossPsi: 1.0 }),
        starterPart("hose_timer_single_zone", "3/4 in FGHT x MGHT hose timer", "controller_timer", 38, 1, 1, input("fght", "3/4"), output("mght", "3/4", "", 5), { pressureLossPsi: 1.5, maxFlowGpm: 5 }),
        starterPart("hose_splitter_2way_3_4_fght_mght", "2-way hose splitter, 3/4 in FGHT x 3/4 in MGHT", "manifold", 16, 1, 2, input("fght", "3/4"), output("mght", "3/4", "", 8), { pressureLossPsi: 1.0, maxFlowGpm: 8 }),
        starterPart("hose_splitter_4way_3_4_fght_mght", "4-way hose manifold, 3/4 in FGHT x 3/4 in MGHT", "manifold", 28, 1, 4, input("fght", "3/4"), output("mght", "3/4", "", 8), { pressureLossPsi: 1.4, maxFlowGpm: 8 }),
        starterPart("fght_to_3_4_mpt_adapter", "3/4 in FGHT to 3/4 in MPT adapter", "source_adapter", 5, 1, 1, input("fght", "3/4"), output("mpt", "3/4"), { pressureLossPsi: 0.2 }),
        starterPart("mght_to_3_4_fpt_adapter", "3/4 in MGHT to 3/4 in FPT adapter", "source_adapter", 5, 1, 1, input("mght", "3/4"), output("fpt", "3/4"), { pressureLossPsi: 0.2 }),
        starterPart("fght_to_3_4_barb_adapter", "3/4 in FGHT to 3/4 in barb adapter", "fitting", 5, 1, 1, input("fght", "3/4"), output("barb", "3/4"), { pressureLossPsi: 0.2 }),
        starterPart("mght_to_3_4_barb_adapter", "3/4 in MGHT to 3/4 in barb adapter", "fitting", 5, 1, 1, input("mght", "3/4"), output("barb", "3/4"), { pressureLossPsi: 0.2 }),
        starterPart("filter_150_mesh_3_4_fpt", "150 mesh filter, 3/4 in FPT", "filter", 32, 1, 1, input("fpt", "3/4"), output("fpt", "3/4"), { pressureLossPsi: 2.0 }),
        ...
        starterPart("mpt_nipple_3_4", "3/4 in MPT close nipple", "fitting", 3, 1, 1, input("mpt", "3/4"), output("mpt", "3/4"), { pressureLossPsi: 0.1 }),
        starterPart("fpt_coupler_3_4", "3/4 in FPT coupler", "fitting", 3, 1, 1, input("fpt", "3/4"), output("fpt", "3/4"), { pressureLossPsi: 0.1 }),
        ...
        starterPart("barb_tee_1", "1 in barb tee", "fitting", 5.5, 1, 2, input("barb", "1"), output("barb", "1"), { pressureLossPsi: 0.2 }),
        starterPart("barb_elbow_1", "1 in barb elbow", "fitting", 4.25, 1, 1, input("barb", "1"), output("barb", "1"), { pressureLossPsi: 0.2 }),
        starterPart("barb_coupler_1", "1 in barb coupler", "fitting", 3.75, 1, 1, input("barb", "1"), output("barb", "1"), { pressureLossPsi: 0.1 }),
        starterPart("end_cap_1_barb", "1 in barb end cap", "cap_end", 2.5, 1, 0, input("barb", "1"), output("", ""), { pressureLossPsi: 0 }),
        starterPart("reducer_1_to_3_4_barb", "1 in barb to 3/4 in barb reducer", "fitting", 4.25, 1, 1, input("barb", "1"), output("barb", "3/4"), { pressureLossPsi: 0.3 }),
        starterPart("adapter_3_4_to_1_barb", "3/4 in barb to 1 in barb adapter", "fitting", 4.25, 1, 1, input("barb", "3/4"), output("barb", "1"), { pressureLossPsi: 0.3 }),
        starterPart("micro_tee_1_4", "1/4 in micro tubing tee", "fitting", 0.75, 1, 2, input("barb", "1/4"), output("barb", "1/4"), { pressureLossPsi: 0.1 }),
        starterPart("micro_elbow_1_4", "1/4 in micro tubing elbow", "fitting", 0.65, 1, 1, input("barb", "1/4"), output("barb", "1/4"), { pressureLossPsi: 0.1 }),
        starterPart("micro_coupler_1_4", "1/4 in micro tubing coupler", "fitting", 0.55, 1, 1, input("barb", "1/4"), output("barb", "1/4"), { pressureLossPsi: 0.05 }),
        starterPart("micro_goof_plug_1_4", "1/4 in goof plug / end plug", "cap_end", 0.35, 1, 0, input("barb", "1/4"), output("", ""), { pressureLossPsi: 0 }),
        starterPart("transfer_barb_1_2_to_1_4", "1/2 in barb to 1/4 in transfer barb", "fitting", 0.85, 1, 1, input("barb", "1/2"), output("barb", "1/4"), { pressureLossPsi: 0.2 }),
        starterPart("adapter_1_4_to_1_2_barb", "1/4 in barb to 1/2 in barb adapter", "fitting", 0.85, 1, 1, input("barb", "1/4"), output("barb", "1/2"), { pressureLossPsi: 0.2 }),
        ...
        starterPart("poly_mainline_1", "1 in poly mainline tubing", "pipe_tubing", 0, 1, 1, input("barb", "1"), output("barb", "1"), { innerDiameterIn: 1.049, hazenWilliamsC: 150 }, 0.9),
        ...
        starterPart("micro_tubing_1_4", "1/4 in micro tubing", "pipe_tubing", 0, 1, 1, input("barb", "1/4"), output("barb", "1/4"), { innerDiameterIn: 0.170, hazenWilliamsC: 150 }, 0.12),
        starterPart("drip_tape_8mil_12in", "8 mil drip tape, 12 in emitter spacing", "drip_tape", 42, 1, 1, input("barb", "1/2", "drip"), output("barb", "1/2", "drip"), { flowGpm: 1.2, flowGpmPerMeter: 1.2, emitterSpacingIn: 12, operatingPressurePsi: 10 }),
        starterPart("pc_dripline_1_2", "1/2 in pressure-compensating dripline", "dripline", 48, 1, 1, input("barb", "1/2", "drip"), output("barb", "1/2", "drip"), { flowGpm: 1.0, flowGpmPerMeter: 1.0, emitterSpacingIn: 12, operatingPressurePsi: 12 }),
        starterPart("micro_emitter_0_5_gph", "1/4 in drip emitter, 0.5 gph", "emitter", 0.45, 1, 0, input("barb", "1/4", "drip"), output("", ""), { flowGpm: 0.0083, operatingPressurePsi: 15 }),
        starterPart("micro_emitter_1_0_gph", "1/4 in drip emitter, 1.0 gph", "emitter", 0.45, 1, 0, input("barb", "1/4", "drip"), output("", ""), { flowGpm: 0.0167, operatingPressurePsi: 15 }),
        starterPart("micro_emitter_2_0_gph", "1/4 in drip emitter, 2.0 gph", "emitter", 0.45, 1, 0, input("barb", "1/4", "drip"), output("", ""), { flowGpm: 0.0333, operatingPressurePsi: 15 }),
        starterPart("overhead_sprinkler_head_30psi", "Overhead sprinkler head/nozzle, 30 psi", "sprinkler", 14, 1, 1, input("barb", "1/2", "sprinkler"), output("barb", "1/2", "sprinkler"), { flowGpm: 2.5, flowGpmPerMeter: 2.5, operatingPressurePsi: 30 }),
        starterPart("microspray_stake_20psi", "Nursery microspray stake, 20 psi", "microspray", 8, 1, 1, input("barb", "1/2", "microspray"), output("barb", "1/2", "microspray"), { flowGpm: 1.5, flowGpmPerMeter: 1.5, operatingPressurePsi: 20 }),
        starterPart("micro_spray_stake_1_4", "1/4 in micro-spray stake, 20 psi", "microspray", 3.5, 1, 0, input("barb", "1/4", "microspray"), output("", ""), { flowGpm: 0.25, operatingPressurePsi: 20 }),
        starterPart("soaker_row_line_1_2", "1/2 in soaker row line", "dripline", 30, 1, 1, input("barb", "1/2", "drip"), output("barb", "1/2", "drip"), { flowGpm: 0.8, flowGpmPerMeter: 0.8, emitterSpacingIn: 12, operatingPressurePsi: 10 }),
        starterPart("bubbler_emitter_1_2", "Perennial bubbler emitter", "bubbler", 5, 1, 1, input("barb", "1/2", "bubbler"), output("barb", "1/2", "bubbler"), { flowGpm: 1.0, flowGpmPerMeter: 1.0, operatingPressurePsi: 15 }),
        starterPart("hose_standpipe_1_2", "Manual hose standpipe", "standpipe", 22, 1, 1, input("barb", "1/2", "standpipe"), output("barb", "1/2", "standpipe"), { flowGpm: 2.0, flowGpmPerMeter: 2.0, operatingPressurePsi: 20 })
    ].concat(GENERATED_CONNECTOR_CATALOG_ITEMS);
    ...
    function generateLabelOnlyConnectorParts() {
        ...
        families.forEach(function (family) {
            sizes.forEach(function (size) {
                parts.push(labelOnlyConnectorPart(family, "coupler", size, size, 1, size.cost, family.label + " " + size.label + " in coupler"));
                parts.push(labelOnlyConnectorPart(family, "tee", size, size, 2, size.cost + 0.75, family.label + " " + size.label + " in tee"));
                parts.push(labelOnlyConnectorPart(family, "elbow", size, size, 1, size.cost + 0.35, family.label + " " + size.label + " in elbow"));
                parts.push(labelOnlyConnectorPart(family, "end_cap", size, null, 0, Math.max(0.75, size.cost - 0.6), family.label + " " + size.label + " in end cap"));
            });
            sizes.forEach(function (from) {
                sizes.forEach(function (to) {
                    if (from.id === to.id) return;
                    const cost = Math.max(from.cost, to.cost) + 0.85;
                    parts.push(labelOnlyConnectorPart(family, "adapter", from, to, 1, cost, family.label + " " + from.label + " in to " + to.label + " in adapter"));
                });
            });
        });
        return parts;
    ...
    function normalizeCatalogSpecs(specs) {
        const normalized = Object.assign({}, specs || {}, normalizeOperatingPressureSpecs(specs || {}));
        delete normalized.operatingPressurePsi;
        return normalized;
    }

    function unitCostAppliesToCategory(category) {
        return ["pipe_tubing", "drip_tape", "dripline"].indexOf(category) >= 0;
    }
    ...
    function createAssemblyLane(moduleCell, label, x, y, type, attrs, size) {
        ...
        const laneHeight = size && size.height != null ? size.height : ASSEMBLY_HEADER_SIZE + ASSEMBLY_PART_HEIGHT + ASSEMBLY_PART_GAP * 2;
    ...
    function createBedAssemblyContainer(moduleCell, label, x, y, attrs, size) {
        ...
        return createVertex(moduleCell, label || "Bed Assembly", x, y, width, height,
            "rounded=1;whiteSpace=wrap;html=1;container=1;recursiveResize=0;collapsible=0;editable=0;fillColor=none;strokeColor=#666666;fontStyle=1;fontSize=14;align=center;verticalAlign=top;spacingTop=6;spacingLeft=6;spacingRight=6;labelBackgroundColor=#ffffff;",
            Object.assign({
    ...
    function resizeAssemblyToChildren(assembly) {
        ...
        const minHeight = ASSEMBLY_HEADER_SIZE + ASSEMBLY_PART_GAP + ASSEMBLY_PART_HEIGHT + ASSEMBLY_PART_GAP;
        const lastBottom = parts.reduce(function (bottom, cell) { const geo = getGeometry(cell) || {}; return Math.max(bottom, finiteNumber(geo.y, 0) + finiteNumber(geo.height, ASSEMBLY_PART_HEIGHT)); }, ASSEMBLY_HEADER_SIZE);
        const height = Math.max(minHeight, lastBottom + ASSEMBLY_PART_GAP);
    ...
    function nextAssemblyPartY(assembly) {
        const parts = assemblyPartCells(assembly);
        return ASSEMBLY_HEADER_SIZE + ASSEMBLY_PART_GAP + parts.length * (ASSEMBLY_PART_HEIGHT + ASSEMBLY_PART_GAP);
    }

    function createAssemblyPartCell(assembly, label, attrs, index) {
        const y = index == null ? nextAssemblyPartY(assembly) : ASSEMBLY_HEADER_SIZE + ASSEMBLY_PART_GAP + index * (ASSEMBLY_PART_HEIGHT + ASSEMBLY_PART_GAP);
    ...
    function updateAssemblyPartCell(cell, part) {
        if (!cell || !part) return;
        const state = partStateForCell(cell);
        setCellAttrs(cell, {
            label: part.name || part.id || "Irrigation part",
            [ATTRS.COMPONENT]: "1",
    ...
    function createPartAssembly(moduleCell, part, anchor) {
        if (activeIrrigationEditDepth === 0) return runIrrigationEdit("createPartAssembly", function () { return createPartAssembly(moduleCell, part, anchor); });
        const point = anchor || { x: 24, y: 72 };
        const assembly = createAssemblyLane(moduleCell, "Assembly", point.x, point.y, "parts", {});
        const partCell = createAssemblyPartCell(assembly, part ? part.name : "Irrigation part", {
            label: part ? part.name : "Irrigation part",
            [ATTRS.COMPONENT]: "1",
            [ATTRS.COMPONENT_TYPE]: part ? part.category : "unknown",
            [ATTRS.CATALOG_PART_ID]: part ? part.id : ""
        });
    ...
    function bedTemplateRowDisplayLabel(irrigationType) {
        const labels = { drip_tape: "Drip line", dripline: "Drip line", sprinkler: "Sprinkler line", microspray: "Microspray line", bubbler: "Bubbler line", standpipe: "Standpipe" };
        const key = String(irrigationType || "").trim();
        return labels[key] || "Irrigation line";
    }

    function bedIrrigationMethodLabel(irrigationType) {
        const labels = { drip_tape: "Drip tape", dripline: "Dripline", emitter: "Emitter", sprinkler: "Sprinkler", microspray: "Microspray", bubbler: "Bubbler", standpipe: "Standpipe" };
        const key = String(irrigationType || "").trim();
        return labels[key] || "";
    }
    ...
    function normalizeBedRecipeInput(catalog, templateDef, recipe) {
        const saved = recipe || {};
        const terminalParts = normalizeBedTerminalPartIds(saved);
        const rowPartId = String(saved.rowPartId || templateDefaultRowPartId(catalog, templateDef) || "").trim();
        const rowPart = partById(catalog, rowPartId);
        const selfEmitting = isSelfEmittingRowPart(rowPart);
        const emitterPartId = selfEmitting ? "" : String(saved.emitterPartId || templateDefaultEmitterPartId(catalog, templateDef, rowPartId) || "").trim();
    ...
    function bedHeaderMatchForPart(catalog, partId, headerPart) {
        return partId ? boundaryMatchForAnchor(partById(catalog, partId), headerPart) : null;
    }
    ...
    function resolveBedTemplateRecipeBom(catalog, bedGeo, templateDef, rowCount, rowOrientation, recipe) {
        ...
        const inletMatch = rowPart ? boundaryMatchForAnchorRole(inletPart, rowPart, "input") : null;
        const supplyPipePartId = inletMatch ? supplyPipePartIdForConnector(catalog, inletMatch.internalConnector) : "";
        ...
        if (normalized.inletPartId && rowPart && !inletMatch) missingPartIds.push(normalized.inletPartId);
    ...
    function bedRolePartOptions(moduleCell, role, selectedPartId, templateId, anchorPartId, preserveSelected) {
        ...
        const items = sortCatalogParts(catalog.items).map(normalizeCatalogPart).filter(function (part) {
            ...
            return !!boundaryMatchForAnchorRole(part, anchorPart, role);
        });
    ...
    function bedRowPartOptions(moduleCell, selectedPartId, preserveSelected) {
        const catalog = readCatalog(moduleCell);
        const items = sortCatalogParts(catalog.items).map(normalizeCatalogPart).filter(function (part) { return part && validateCatalogPart(part).ok && BED_TEMPLATE_ANCHOR_CATEGORIES.has(part.category); });
    ...
    function bedFittingPartOptions(moduleCell, role, headerPartId, rowPartId, selectedPartId, preserveSelected) {
        ...
        const items = sortCatalogParts(catalog.items).map(normalizeCatalogPart).filter(function (part) {
            ...
            if (role === "row_takeoff") return part.category === "fitting" && connectorMatchesPartInput(part, headerConnector) && connectorMatchesPartOutput(part, rowConnector);
            if (role === "row_end_cap") return (part.category === "cap_end" || part.category === "fitting") && part.connectors.outputs <= 0 && connectorMatchesPartInput(part, rowConnector);
            if (role === "header_end_cap") return (part.category === "cap_end" || part.category === "fitting") && part.connectors.outputs <= 0 && connectorMatchesPartInput(part, headerConnector);
            return false;
        });
        return preserveSelectedPartOption(items, catalog, selectedPartId, preserveSelected);
    }
    ...
    function bedOutletPartOptions(moduleCell, headerPartId, selectedPartId, preserveSelected) {
        ...
        const headerPart = partById(catalog, headerPartId);
        const items = sortCatalogParts(catalog.items).map(normalizeCatalogPart).filter(function (part) {
            return part && part.category !== "pipe_tubing" && part.category !== "cap_end" && !BED_TEMPLATE_ANCHOR_CATEGORIES.has(part.category) && !BED_DEVICE_CATEGORIES.has(part.category) && validateCatalogPart(part).ok && !!boundaryMatchForAnchorRole(part, headerPart, "output");
        });
        return preserveSelectedPartOption(items, catalog, selectedPartId, preserveSelected);
    }
    ...
    function bedPortConfigFromRecipe(catalog, currentPorts, inletPartId, outletPartId, rowPartId, supplyPipePartId) {
        ...
        const inletMatch = rowPart ? boundaryMatchForAnchorRole(partById(catalog, inletPartId), rowPart, "input") : null;
        const outletMatch = supplyPart ? boundaryMatchForAnchorRole(partById(catalog, outletPartId), supplyPart, "output") : null;
    ...
    function updateConnectionEdgeAttrs(edge, decision) {
        ...
        else { setCellAttrs(edge, { [ATTRS.PIPE_EDGE]: "", [ATTRS.DIRECT_LINK_EDGE]: "1", [ATTRS.PIPE_PART_ID]: "", [ATTRS.EDGE_SOURCE_PORT]: String(decision.source.index), [ATTRS.EDGE_TARGET_PORT]: String(decision.target.index) }); applyDirectLinkEdgeStyle(edge); syncConnectionEdgeDisplayLabel(findGardenModuleAncestor(edge), edge); }
    }
    ...
    function reflowAssemblyParts(assembly) {
        assemblyPartCells(assembly).forEach(function (cell, index) {
            setGeometry(cell, { y: ASSEMBLY_HEADER_SIZE + ASSEMBLY_PART_GAP + index * (ASSEMBLY_PART_HEIGHT + ASSEMBLY_PART_GAP) });
        });
        resizeAssemblyToChildren(assembly);
    }

    function insertAssemblyPartAt(assembly, part, index) {
        const parts = assemblyPartCells(assembly);
        ...
        parts.forEach(function (cell, cellIndex) {
            if (cellIndex >= insertIndex) {
                const geo = getGeometry(cell) || {};
                setGeometry(cell, { y: finiteNumber(geo.y, ASSEMBLY_HEADER_SIZE + ASSEMBLY_PART_GAP) + ASSEMBLY_PART_HEIGHT + ASSEMBLY_PART_GAP });
            }
        });
        const cell = createAssemblyPartCell(assembly, part.name, { label: part.name, [ATTRS.COMPONENT]: "1", [ATTRS.COMPONENT_TYPE]: part.category, [ATTRS.CATALOG_PART_ID]: part.id }, insertIndex);
    ...
    function partCanReceiveFromConnector(part, connector) {
        ...
        return connectorRecordsMatch(connector, p.connectors.input, null).ok;
    }

    function partHasPipeCapableInput(part) {
        const p = normalizeCatalogPart(part);
        return !!(p && p.connectors.inputs > 0 && connectorUsesPipe(p.connectors.input));
    }

    function partCanFeedConnector(part, connector) {
        const p = normalizeCatalogPart(part);
        if (!p || p.category === "pipe_tubing" || p.connectors.outputs <= 0) return false;
        return connectorRecordsMatch(p.connectors.output, connector, null).ok;
    }
    ...
    function partAllowedForConnectionRow(moduleCell, row, part) {
        if (isExposedAssemblyOutletRow(row) && !partHasPipeCapableInput(part)) return false;
        return true;
    }
    ...
    function addPartPickerParts(session, context) {
        ...
        return sortAddPartPickerParts(baseParts.filter(function (part) { return !suppressed.has(part.category); }));
    }
    ...
    function addPartContextLabel(moduleCell, context) {
        ...
        const connector = ConnectorRules.portConnectorForCell(moduleCell, cell, role);
        return (role === "output" ? "outlet" : "inlet") + " " + ((context.row.index || 0) + 1) + " on " + irrigationCellLabel(cell) + " (" + connectorLabel(connector) + ")";
    }
    ...
    function broadCategorySortIndex(part) {
        const id = broadCategoryForCatalogCategory(normalizeCatalogPart(part).category).id;
        const index = BROAD_CATALOG_CATEGORIES.findIndex(function (entry) { return entry.id === id; });
        return index < 0 ? BROAD_CATALOG_CATEGORIES.length : index;
    }
    ...
    function sortAddPartPickerParts(parts) {
        return (parts || []).slice().sort(function (a, b) {
            ...
            return (stockA - stockB) || (broadCategorySortIndex(a) - broadCategorySortIndex(b)) || keyA.category.localeCompare(keyB.category) || compareNominalSize(keyA.size, keyB.size) || keyA.name.localeCompare(keyB.name);
        });
    }
    ...
    function appendGroupedPartOptions(select, parts) {
        ...
        (parts || []).forEach(function (part) {
            const label = addPartStockGroupLabel(part) + " / " + catalogBroadCategoryLabel(part);
            if (!grouped.has(label)) grouped.set(label, []);
            grouped.get(label).push(part);
        });
        if (!grouped.size) { appendSelectOption(select, "", "No compatible parts"); select.disabled = true; return; }
        grouped.forEach(function (groupParts, label) {
            const group = document.createElement("optgroup");
            group.label = label;
            groupParts.forEach(function (part) { appendSelectOption(group, part.id, part.name); });
            select.appendChild(group);
        });
    }

    function pipeEdgeLabel(moduleCell, edge, port) {
        if (!edge) return normalizePort(port).role === "output" ? "Available: " + portDisplayLabel(moduleCell, port) + " downstream connection" : "Available: " + portDisplayLabel(moduleCell, port) + " upstream connection";
    ...
    function shortCatalogPartName(part) {
        ...
        return name.replace(/^\s*(?:\d+(?:\.\d+)?|\d+\s*\/\s*\d+)\s*(?:in|inch|inches)\s+/i, "").trim() || name;
    }
    ...
    function commitBedTemplate(moduleCell, pathId, bedCell, template) {
        ...
        const record = {
            ...
            irrigationType: template && template.irrigationType && template.irrigationType !== templateDef.id ? template.irrigationType : templateDef.lineKind,
        ...
        try {
            ...
            if (bedAssembly) {
                setCellAttrs(bedAssembly, { label: assemblyLabelForTemplateRecord(record), [ATTRS.BED_TEMPLATE_JSON]: JSON.stringify(record) });
    ...
    function assemblyLabelForTemplateRecord(record) {
        return record && record.assemblyLabelMode === BED_ASSEMBLY_LABEL_HIDDEN ? "" : bedTemplateLabel(record && record.templateId);
    }
    ...
    function rowMetricRecordForGeometry(moduleCell, record, bedGeo) {
        ...
        return {
            record: Object.assign({}, record, {
                ...
                resolvedBomParts: bom.recipe ? bom.recipe.resolvedBomParts : record.resolvedBomParts,
                supplyPipePartId: bom.recipe ? bom.recipe.supplyPipePartId : record.supplyPipePartId,
                anchorPartId: bom.anchorPartId,
                demand: bom.demand,
                spacing: Object.assign({}, record.spacing || {}, { rows: bom.rowCount, rowSpacingCm: bom.rowSpacingCm })
            }),
            recomputed: true
        };
    }
    ...
    function refreshBedAssemblyRowsFromTemplate(moduleCell, bedAssembly, bedCell, record) {
        ...
        if (nextRecord.assemblyLabelMode === BED_ASSEMBLY_LABEL_HIDDEN) changed = setCellAttrs(bedAssembly, { label: assemblyLabelForTemplateRecord(nextRecord) }) || changed;
    ...
    function normalizeBedIrrigationMethodId(record) {
        const template = bedTemplateById(record && record.templateId);
        return String(record && record.irrigationType || template && template.lineKind || "").trim();
    }
    ...
    function estimatePathHydraulics(args) {
        ...
        if (pipeSegments.length) {
            pipeSegments.forEach(function (segment) {
                ...
                if (!(segment.lengthFt > 0)) { warnings.push("Pipe edge length is missing; pressure loss was not estimated."); return; }
    ...
    function formatBomCanonicalQuantity(quantity, part, moduleCell) {
        return bomDisplayQuantityValue(quantity, part, moduleCell) + " " + bomCanonicalUnitLabel(part, moduleCell);
    }

    function bomLineUnitCost(part, moduleCell) {
        return formatMoney(bomDisplayUnitCost(part, moduleCell)) + "/" + bomCanonicalUnitLabel(part, moduleCell);
    }
    ...
    function compareBomRows(a, b) {
        ...
        return ka.category.localeCompare(kb.category) || compareNominalSize(ka.size, kb.size) || ka.name.localeCompare(kb.name);
    }
    ...
    function openBomDialog(moduleCell, options) {
        ...
        div.className = "trellis-irrigation-bom-dialog";
        div.style.cssText = "width:960px;max-width:96vw;max-height:84vh;overflow:auto;font:12px Arial,sans-serif;padding:12px;box-sizing:border-box;";
        showDialog(div, 980, 640);
    ...
    function renderBomDialog(container, moduleCell, state) {
        ...
        const bom = ReportModel.buildBomRows(moduleCell, { catalog, selectedPartIds: state.selectedScopeActive ? selectedScopePartIds : [] });
        const visibleRows = bomVisibleRows(bom.rows, state, moduleCell);
        const visibleCompletedRows = bomVisibleRows(bom.completedRows || [], state, moduleCell);
        const totals = bomTotals(visibleRows);
        const completedTotals = bomTotals(visibleCompletedRows);
        const filterOptions = catalogFilterOptions({ items: bom.rows.concat(bom.completedRows || []).map(function (row) { return row.part; }) });
        container.innerHTML = "";
        ...
        totalText.textContent = "Planned " + formatMoney(totals.totalCost) + " | Purchase " + formatMoney(totals.purchaseCost) + " | Completed " + formatMoney(completedTotals.totalCost);
        ...
        search.addEventListener("input", function () { state.search = search.value; renderBomDialog(container, moduleCell, state); });
        ...
        broadFilter.addEventListener("change", function () { state.broadCategoryFilter = broadFilter.value; renderBomDialog(container, moduleCell, state); });
        filterRow.appendChild(broadFilter);
        const categoryFilter = document.createElement("select");
        appendSelectOption(categoryFilter, "", "All categories");
        PART_CATEGORIES.forEach(function (category) { appendSelectOption(categoryFilter, category, category.replace(/_/g, " ")); });
        ...
        table.style.cssText = "width:100%;border-collapse:collapse;min-width:980px;";
        table.innerHTML = "<thead><tr><th>Part</th><th>Category</th><th>Size</th><th>Stock</th><th>Required</th><th>On hand</th><th>Shortage</th><th>Unit cost</th><th>Total planned</th><th>Purchase</th><th>Actions</th></tr></thead>";
        const tbody = document.createElement("tbody");
        let lastGroup = "";
        visibleRows.forEach(function (row) {
            const group = catalogGroupLabel(row.part);
            if (group !== lastGroup) {
                lastGroup = group;
                const groupRow = document.createElement("tr");
                groupRow.className = "trellis-irrigation-bom-group";
                groupRow.innerHTML = "<td colspan=\"11\">" + html(group) + "</td>";
                groupRow.children[0].style.cssText = "border-bottom:1px solid #d1d5db;padding:6px;background:#eef2f7;font-weight:700;color:#1f2937;";
        ...
        if (!visibleRows.length) {
            ...
            emptyRow.innerHTML = "<td colspan=\"11\">No planned BOM rows match the current scope and filters.</td>";
        ...
        if (visibleCompletedRows.length) {
            ...
            container.appendChild(renderCompletedBomTable(moduleCell, visibleCompletedRows));
        }

        const controls = document.createElement("div");
        controls.style.cssText = "display:flex;gap:8px;margin-top:10px;flex-wrap:wrap;justify-content:flex-end;";
        controls.appendChild(button("Export CSV", function () { downloadBomCsv(moduleCell, visibleRows, state); }));
    ...
    function renderBomRow(container, moduleCell, state, row) {
        ...
        appendBomCell(tr, row.part.category);
        appendBomCell(tr, catalogPartSizeLabel(row.part));
        appendBomCell(tr, row.stockState);
        appendBomCell(tr, formatBomCanonicalQuantity(row.requiredQuantity, row.part, moduleCell));
        appendBomInputCell(tr, onHand);
        appendBomCell(tr, formatBomCanonicalQuantity(row.shortageQuantity, row.part, moduleCell));
        appendBomInputCell(tr, unitCost, "/" + bomCanonicalUnitLabel(row.part, moduleCell));
    ...
    function bomRowMatchesFilters(row, state) {
        ...
        if (search && (String(part.name || "").toLowerCase().indexOf(search) < 0 && String(part.id || "").toLowerCase().indexOf(search) < 0 && String(part.category || "").toLowerCase().indexOf(search) < 0)) return false;
        ...
        if (state.categoryFilter && part.category !== state.categoryFilter) return false;
        if (state.broadCategoryFilter && broadCategoryForCatalogCategory(part.category).id !== state.broadCategoryFilter) return false;
    ...
    function buildBomCsv(moduleCell, rows) {
        ...
        push(["Part", "Category", "Size", "Stock", "Required", "On hand", "Shortage", "Unit cost", "Total required", "Purchase"]);
        (rows || []).forEach(function (row) {
            push([
                ...
                formatBomCanonicalQuantity(row.shortageQuantity, row.part, moduleCell),
    ...
    function openCatalogManager(moduleCell) {
        ...
        const state = { selectedId: selectedPartIds[0] || "", selectedScopeActive: selectedPartIds.length > 0, selectedPartIds };
        const div = document.createElement("div");
    ...
    function renderCatalogManager(container, moduleCell, state) {
        ...
        const filterOptions = catalogFilterOptions(catalog);
        const visibleItems = sortCatalogParts(scopedItems.filter(function (part) { return catalogPartMatchesFilters(part, state); }));
        let catalogSelected = partById(catalog, state.selectedId);
        if (state.selectedScopeActive && (!catalogSelected || selectedScopePartIds.indexOf(catalogSelected.id) < 0)) catalogSelected = visibleItems[0] || partById(catalog, selectedScopePartIds[0]);
        else if (!catalogSelected) catalogSelected = visibleItems[0] || catalog.items[0] || makeBlankPart(catalog);
        const selected = normalizeCatalogPart(state.partDrafts[catalogSelected.id] || catalogSelected);
        ...
        filterOptions.broadCategories.forEach(function (entry) { appendSelectOption(broadFilter, entry.id, entry.label); });
        broadFilter.value = state.broadCategoryFilter;
        broadFilter.addEventListener("change", function () { state.broadCategoryFilter = broadFilter.value; state.selectedId = ""; renderCatalogManager(container, moduleCell, state); });
        filterRow.appendChild(broadFilter);
        const categoryFilter = document.createElement("select");
        ...
        table.innerHTML = "<thead><tr><th>Name</th><th>Broad</th><th>Category</th><th>Size</th><th>Connections</th><th>Stock</th><th>On hand</th><th>Status</th></tr></thead>";
        const tbody = document.createElement("tbody");
        ...
        visibleItems.forEach(function (part) {
            ...
            if (group !== lastCatalogGroup) {
                ...
                groupRow.innerHTML = "<td colspan=\"8\">" + html(group) + "</td>";
            ...
            tr.addEventListener("click", function () {
                ...
                delete state.partDrafts[part.id];
        ...
        if (visibleItems.length === 0) {
            ...
            emptyRow.innerHTML = "<td colspan=\"8\">No catalogue parts match the current filters.</td>";
        ...
        const form = buildCatalogPartForm(selected, moduleCell, function (draft) { state.partDrafts[draft.id] = draft; state.selectedId = draft.id; renderCatalogManager(container, moduleCell, state); });
    ...
    function applyDirectLinkEdgeStyle(edge) {
        return setCellStyle(edge, DIRECT_LINK_EDGE_STYLE);
    }
    ...
    function buildCatalogPartForm(part, moduleCell, onCategoryChange) {
        ...
        fields.stockState = addSelectField(node, "Stock", VALID_STOCK_STATES, stockStateForQuantity(part.stockQuantity));
        fields.stockState.disabled = true;
        fields.stockQuantity = addTextField(node, "Quantity on hand", bomDisplayQuantityValue(part.stockQuantity, part, moduleCell));
        ...
        if (category === "pipe_tubing") {
            ...
            return normalizeCatalogPart({
                ...
                connectors: {
                    inputs: 1,
                    outputs: 1,
                    input: { type: "barb", nominalSize: pipeSize },
                    output: { type: "barb", nominalSize: pipeSize, maxFlowGpm: null }
                },
                specs: { innerDiameterIn: form.fields.innerDiameterIn ? finiteNumber(form.fields.innerDiameterIn.value, null) : null }
            });
        }
        return normalizeCatalogPart({
            id: sanitizeId(form.fields.id.value) || "part",
    ...
    function addSelectField(parent, label, values, value) {
        ...
        values.forEach(function (entry) {
            ...
            option.value = entry;
            option.textContent = connectorTypeLabel(entry);
    ...
    function addPartSelectField(parent, label, parts, value) {
        ...
        wrap.textContent = label;
        const select = document.createElement("select");
        appendSelectOption(select, "", "Choose part");
        (parts || []).forEach(function (part) { appendSelectOption(select, part.id, part.name || part.id); });
        select.value = value || "";
        select.style.cssText = "width:100%;min-width:0;max-width:100%;box-sizing:border-box;overflow:hidden;padding:4px;border:1px solid #aaa;border-radius:4px;";
        wrap.appendChild(select);
        parent.appendChild(wrap);
    ...
    function catalogFilterOptions(catalog) {
        const broadIds = new Set();
        const sizes = new Set();
        const connectorTypes = new Set(FIXED_CONNECTOR_TYPES);
        const connectionCounts = new Set();
        (catalog.items || []).map(normalizeCatalogPart).forEach(function (part) {
            if (!part) return;
    ...
    function catalogPartMatchesFilters(part, state) {
        const p = normalizeCatalogPart(part);
        if (state.categoryFilter && p.category !== state.categoryFilter) return false;
        if (state.broadCategoryFilter && broadCategoryForCatalogCategory(p.category).id !== state.broadCategoryFilter) return false;
        if (state.sizeFilter && catalogPartSizes(p).indexOf(state.sizeFilter) < 0) return false;
        if (state.connectorTypeFilter && catalogPartConnectorTypes(p).indexOf(state.connectorTypeFilter) < 0) return false;
        if (state.connectionFilter && String(catalogPartConnectionCount(p)) !== String(state.connectionFilter)) return false;
        return true;
    }
    ...
    function catalogPartSortKey(part) {
        ...
        return { category: p && p.category || "", size, name: p && p.name || p && p.id || "" };
    }

    function catalogGroupLabel(part) {
        const key = catalogPartSortKey(part);
        return (key.category || "uncategorized").replace(/_/g, " ") + " / " + (key.size || "no output size");
    }
    ...
    function installIrrigationModeListeners(session) {
        ...
        if (selectionModel && selectionModel.addListener && typeof mxEvent !== "undefined") {
            const listener = function () { syncSelectedBedAssemblyLayering(session); renderIrrigationMode(session); };
        ...
        if (graph.addMouseListener) {
            const mouseListener = {
                mouseDown: function (_, evt) { updateSessionPointerFromMouseEvent(session, evt); },
                mouseMove: function (_, evt) { updateSessionPointerFromMouseEvent(session, evt); },
    ...
    function renderIrrigationMode(session) {
        ...
        removeNodeList(session.inlineActionNodes);
        removeNodeList(session.zoneBadges);
        session.portBadgeNodeByKey = new Map();
        session.connectionBadgeNodeByKey = new Map();
        ...
        if (!inlineAction && hudEligible) {
            ...
            shieldHudEvents(hud);
            if (connectionContext) renderConnectionHud(session, hud, connectionContext);
    ...
    function renderLocalIrrigationHud(session, hud, cells) {
        ...
        const bridgePorts = selectedBridgeSuggestionPorts(session);
        if (bridgePorts) { session.bridgePorts = bridgePorts; renderBridgeSuggestions(session, hud, bridgePorts); return; }
        ...
        appendLocalAssemblyFoldActions(session, hud, selected);
    ...
    function renderConnectionRow(session, wrap, row) {
        ...
        label.textContent = (row.role === "input" ? "Inlet " : "Outlet ") + (row.index + 1);
    ...
    function renderConnectionDropdown(session, row) {
        ...
        function focusCategoryButton(categoryKey) {
            ...
            const buttons = Array.from(state.list.querySelectorAll(".trellis-irrigation-connection-combobox-category"));
                ...
                categories.forEach(function (category, categoryIndex) {
                    ...
                    if (!collapsed) {
                        category.parts.forEach(function (part) {
                            ...
                            option.type = "button";
                            option.className = "trellis-irrigation-connection-combobox-option";
                            option.setAttribute("role", "option");
                            option.setAttribute("data-part-id", part.id);
                            option.style.cssText = "display:flex;flex-direction:column;gap:1px;width:100%;padding:5px 8px 5px 18px;border:0;border-top:1px solid #f3f4f6;background:#fff;color:#111827;text-align:left;box-sizing:border-box;cursor:pointer;";
                            const name = document.createElement("span");
                            name.textContent = part.name || part.id;
                            const detail = document.createElement("span");
                            detail.style.cssText = "font-size:11px;color:#6b7280;";
                            detail.textContent = connectionComboboxPartDetail(part);
                            option.appendChild(name);
                            option.appendChild(detail);
                            option.addEventListener("click", function () { choosePart(part.id); });
                            option.addEventListener("keydown", function (ev) {
                                if (ev.key === "ArrowDown") { ev.preventDefault(); moveOption(1); }
                                else if (ev.key === "ArrowUp") { ev.preventDefault(); moveOption(-1); }
                                else if (ev.key === "Enter") { ev.preventDefault(); choosePart(part.id); }
                                else if (ev.key === "Escape") { ev.preventDefault(); closeMenu(true); }
                            });
    ...
    function connectionComboboxCategoryGroups(parts, query) {
        ...
        return Array.from(grouped.keys()).sort(compareCatalogCategories).map(function (category) { return { category, parts: grouped.get(category) }; });
    }
    ...
    function sortConnectionComboboxParts(parts) {
        return (parts || []).map(normalizeCatalogPart).filter(Boolean).sort(function (a, b) {
            const ka = catalogPartSortKey(a);
            const kb = catalogPartSortKey(b);
            return compareCatalogCategories(ka.category, kb.category) || compareNominalSize(ka.size, kb.size) || ka.name.localeCompare(kb.name);
        });
    }
    ...
    function compareCatalogCategories(a, b) {
        ...
        const sortA = indexA < 0 ? PART_CATEGORIES.length : indexA;
        const sortB = indexB < 0 ? PART_CATEGORIES.length : indexB;
        return (sortA - sortB) || String(a || "").localeCompare(String(b || ""));
    }

    function catalogCategoryLabel(category) {
        return String(category || "uncategorized").replace(/_/g, " ");
    }
    ...
    function connectionDropdownGroups(moduleCell, row) {
        ...
        if (!occupied) return { keep: parts, disconnect: [] };
        ...
        return { keep, disconnect: parts.filter(function (part) { return !keepIds.has(part.id); }) };
    }
    ...
    function applyBedPortPartChoice(session, row, part) {
        ...
        const created = createPartAssembly(session.moduleCell, part, bedPortPartAnchor(row.cell, row.role, row.index));
    ...
    function bedPortPartAnchor(bedAssembly, role, index) {
        ...
        if (role === "input") return { x: finiteNumber(geo.x, 24), y: Math.max(24, finiteNumber(geo.y, 72) - ASSEMBLY_PART_HEIGHT - ASSEMBLY_PART_GAP - ASSEMBLY_HEADER_SIZE - 40 - slotOffset) };
    ...
    function applyLinearConnectionChoice(moduleCell, row, part) {
        ...
        try {
            ...
            const inserted = insertAssemblyPartAt(assembly, part, row.role === "input" ? freshIndex : freshIndex + 1);
    ...
    function dropdownPartConnectionDecision(moduleCell, row, part) {
        ...
        const partConnector = row.role === "input" ? p.connectors.output : p.connectors.input;
        if (!partConnector) return { ok: false, reason: "Selected part does not have a compatible connector." };
        const sourceConnector = row.role === "input" ? partConnector : rowConnector;
        const targetConnector = row.role === "input" ? rowConnector : partConnector;
        return Object.assign({ pipeRequired: ConnectorRules.connectorsRequirePipe(sourceConnector, targetConnector), sourceConnector, targetConnector }, ConnectorRules.connectionMode(moduleCell, sourceConnector, targetConnector));
    }
    ...
    function linearDropdownPartAnchor(row) {
        ...
        const height = finiteNumber(geo.height, ASSEMBLY_HEADER_SIZE + ASSEMBLY_PART_HEIGHT + ASSEMBLY_PART_GAP * 2);
        const slotOffset = Math.max(0, Math.floor(finiteNumber(row.index, 0))) * 28;
        return row.role === "input" ? { x, y: Math.max(24, y - ASSEMBLY_HEADER_SIZE - ASSEMBLY_PART_HEIGHT - ASSEMBLY_PART_GAP - 40 - slotOffset) } : { x, y: y + height + 40 + slotOffset };
    }
    ...
    function applyBranchOutletChoice(moduleCell, row, part) {
        ...
        model.beginUpdate && model.beginUpdate();
        try {
            if (edge && branchCanReuseDownstream(moduleCell, row.cell, part, edge.target)) {
                ...
                updateAssemblyPartCell(edge.target, part);
                const decision = existingEdgeConnectionDecision(moduleCell, { cellId: getCellId(row.cell), role: "output", index: row.index }, { cellId: getCellId(edge.target), role: "input", index: 0 });
                if (!decision.ok) { irrigationDebug("branchOutletChoice:reuse-rejected", { reason: decision.reason, sourceCell: debugCellSummary(row.cell), outletIndex: row.index, edge: debugCellSummary(edge), downstream: debugCellSummary(edge.target) }); removeCellFromParent(edge); return { cell: edge.target, message: "Old branch disconnected; replacement is not compatible." }; }
            ...
            const created = createBranchAssemblyFromOutlet(moduleCell, row, part);
            return { cell: created && created.assembly, message: edge ? "Old branch disconnected; new branch created." : "Branch swimlane created." };
        } finally { model.endUpdate && model.endUpdate(); }
    }

    function branchCanReuseDownstream(moduleCell, sourceCell, part, downstreamCell) {
        const p = normalizeCatalogPart(part);
        if (!downstreamCell || !p || p.category === "pipe_tubing" || p.connectors.inputs <= 0) return false;
        if (!ConnectorRules.connectionMode(moduleCell, ConnectorRules.portConnectorForCell(moduleCell, sourceCell, "output"), p.connectors.input).ok) return false;
        ...
        return ConnectorRules.connectorMatches(p.connectors.output, ConnectorRules.portConnectorForCell(moduleCell, second, "input"), null).ok;
    }

    function createBranchAssemblyFromOutlet(moduleCell, row, part) {
        ...
        const created = createPartAssembly(moduleCell, part, anchor);
    ...
    function selectedValidPorts(session) {
        return (session.selectedPorts || []).map(normalizePort).filter(function (port) {
            return port.cellId && portCell(session.moduleCell, port) && (port.role === "input" || port.role === "output");
        });
    }
    ...
    function debugPortSummary(moduleCell, port) {
        const normalized = normalizePort(port);
        const cell = portCell(moduleCell, normalized);
        const visualRole = cell ? portVisualRoleForCell(moduleCell, cell, normalized.role) : normalized.role;
    ...
    function flipAndConnectSelectedPorts(session, ports) {
        const result = runIrrigationEdit("flipAndConnectSelectedPorts", function () {
            ...
            if (!connected.ok) { setPartCellFlipped(plan.flipCell, previous); irrigationDebug("flipAndConnectSelectedPorts:rollback", { reason: connected.reason || "", restoredAttr: getCellAttr(plan.flipCell, ATTRS.PART_FLIPPED, ""), restoredFlipped: isPartCellFlipped(plan.flipCell), flipCell: debugCellSummary(plan.flipCell) }); return connected; }
            scheduleHudGraphStateSync(session.moduleCell);
            return connected;
        });
    ...
    function resolveInlineConnectionAction(session) {
        ...
        if (ports.length === 2 && selectedBoundaries.length === 0) {
            ...
            irrigationDebug("inlineConnectionAction:selected-pair", { freeCount: free.length, ordered: ordered ? { source: debugPortSummary(session.moduleCell, ordered.source), target: debugPortSummary(session.moduleCell, ordered.target) } : null, ports: ports.map(function (port) { return debugPortSummary(session.moduleCell, port); }) });
    ...
    function renderBridgeSuggestions(session, hud, orderedPorts) {
        ...
        wrap.appendChild(hudText("Suggest Connection"));
    ...
    function bridgeSuggestionsForPorts(moduleCell, sourcePort, targetPort) {
        ...
        const items = sortCatalogParts(catalog.items).map(normalizeCatalogPart).filter(function (part) { return part && bridgeSuggestionPartAllowed(part) && validateCatalogPart(part).ok; });
        ...
        while (queue.length && results.length < 40) {
            ...
            items.forEach(function (candidate) {
                if (!candidate.id || state.seen.has(candidate.id)) return;
                if (!canConnectParts(state.last, candidate, targetRequirement).ok) return;
                const nextSeen = new Set(Array.from(state.seen));
                nextSeen.add(candidate.id);
                queue.push({ last: candidate, parts: state.parts.concat([candidate]), seen: nextSeen });
            });
        }
    ...
    function applyBridgeSuggestion(session, sourcePort, targetPort, suggestion) {
        ...
        const parts = (suggestion.partIds || []).map(function (partId) { return partById(readCatalog(session.moduleCell), partId); }).filter(Boolean);
    ...
    function planBridgeConnectionChain(moduleCell, sourcePort, targetPort, parts) {
        ...
        const normalizedParts = (parts || []).map(normalizeCatalogPart).filter(Boolean);
        if (!normalizedParts.length) return { ok: false, reason: "No bridge parts selected." };
        if (!normalizedParts.every(bridgeSuggestionPartAllowed)) return { ok: false, reason: "Bridge suggestions must use one-inlet, one-outlet adapters or fittings." };
        ...
        for (let i = 0; i < nodes.length - 1; i++) {
            const sourceConnector = chainNodeOutputConnector(moduleCell, nodes[i]);
            const targetConnector = chainNodeInputConnector(moduleCell, nodes[i + 1]);
            const compatibility = ConnectorRules.connectionMode(moduleCell, sourceConnector, targetConnector);
            if (!compatibility.ok) return { ok: false, reason: compatibility.reason || "Bridge parts are not compatible." };
            hops.push(Object.assign({}, compatibility, { sourceNode: nodes[i], targetNode: nodes[i + 1], sourceConnector, targetConnector }));
        }
        return { ok: true, sourcePort: normalizePort(sourcePort), targetPort: normalizePort(targetPort), sourceCell: bridge.sourceCell, targetCell: bridge.targetCell, parts: normalizedParts, nodes, hops, hasPipe: hops.some(function (hop) { return hop.mode === "pipe"; }) };
    }
    ...
    function chainNodeInputConnector(moduleCell, node) {
        ...
        return node.part && node.part.connectors && node.part.connectors.input;
    }
    ...
    function chainNodeOutputConnector(moduleCell, node) {
        ...
        return node.part && node.part.connectors && node.part.connectors.output;
    }
    ...
    function applyExternalPartConnection(moduleCell, row, part) {
        ...
        const createdEdges = [];
        try {
            const created = createPartAssembly(moduleCell, part, linearDropdownPartAnchor(row));
    ...
    function applyInlineBridgeConnectionChain(moduleCell, plan) {
        ...
        const inserted = insertBridgePartsBefore(moduleCell, targetAssembly, plan.targetCell, plan.parts);
    ...
    function applyExternalBridgeConnectionChain(moduleCell, plan) {
        ...
        try {
            ...
            groups.forEach(function (group, groupIndex) {
                const created = createBridgePartAssembly(moduleCell, group.parts, bridgeGroupAnchor(plan.sourceCell, plan.targetCell, groupIndex, groups.length));
                createdAssemblies.push(created.assembly);
    ...
    function sourceDirectBridgePrefixCount(plan, sourceAssembly) {
        ...
        let count = 0;
        while (count < plan.parts.length && plan.hops[count] && plan.hops[count].mode === "direct") count++;
        return count;
    }
    ...
    function appendSourceBridgePrefix(sourceAssembly, plan, count) {
        ...
        const inserted = [];
        for (let i = 0; i < count; i++) inserted.push(insertAssemblyPartAt(sourceAssembly, plan.parts[i], insertAt + i));
        return inserted;
    }
    ...
    function bridgePartGroupsForPlan(plan, startIndex) {
        const groups = [];
        let current = null;
        plan.parts.forEach(function (part, index) {
    ...
    function createBridgePartAssembly(moduleCell, parts, anchor) {
        const created = createPartAssembly(moduleCell, parts[0], anchor);
        const cells = [created.partCell];
        for (let i = 1; i < parts.length; i++) cells.push(insertAssemblyPartAt(created.assembly, parts[i], assemblyPartCells(created.assembly).length));
    ...
    function createPlannedConnectionEdge(moduleCell, sourceCell, targetCell, hop, sourceIndex, targetIndex) {
        ...
        let edge = null;
        programmaticEdgeInsertDepth++;
        try { edge = createEdge(moduleCell, sourceCell, targetCell, label, style, attrs); }
    ...
    function insertBridgePartsBefore(moduleCell, assembly, beforeCell, parts) {
        const shift = parts.length * (ASSEMBLY_PART_HEIGHT + ASSEMBLY_PART_GAP);
        const existing = assemblyPartCells(assembly);
        model.beginUpdate && model.beginUpdate();
        try {
            existing.forEach(function (cell) {
                const geo = getGeometry(cell) || {};
                setGeometry(cell, { y: finiteNumber(geo.y, ASSEMBLY_HEADER_SIZE + ASSEMBLY_PART_GAP) + shift });
            });
            const inserted = parts.map(function (part, index) {
                return createAssemblyPartCell(assembly, part.name, { label: part.name, [ATTRS.COMPONENT]: "1", [ATTRS.COMPONENT_TYPE]: part.category, [ATTRS.CATALOG_PART_ID]: part.id }, index);
            });
            resizeAssemblyToChildren(assembly);
            return inserted;
        } finally { model.endUpdate && model.endUpdate(); }
    ...
    function renderBedInletFields(session, hud, assemblyCell) {
        ...
        const initialRecipe = normalizeBedRecipeInput(initialCatalog, savedTemplateDef, saved);
        ...
        const templateSection = hudSection("Irrigation Template");
        ...
        const templateSelect = addSelectField(layoutColumn, "Template", BED_TEMPLATES.map(function (entry) { return entry.id; }), savedTemplateId);
        ...
        const rowTakeoffPart = addPartSelectField(partsColumn, "Row takeoff part", bedFittingPartOptions(session.moduleCell, "row_takeoff", initialBom.recipe && initialBom.recipe.supplyPipePartId, initialRecipe.rowPartId, initialRecipe.rowTakeoffPartId), initialRecipe.rowTakeoffPartId);
        const rowPart = addPartSelectField(partsColumn, "Row part", bedRowPartOptions(session.moduleCell, initialRecipe.rowPartId), initialRecipe.rowPartId);
        ...
        function syncRowSpacingFromRows() {
            const templateDef = bedTemplateById(templateSelect.value);
        ...
        function currentDraft() {
            ...
            const bom = computeBedTemplateBom(catalog, currentBedTemplateGeometry(), templateSelect.value, rowCount, orientation.value, recipeInput);
            return {
                catalog,
                bom,
        ...
        function refreshTemplatePreview(clearInvalidSelections) {
            ...
            const bom = draft.bom;
            const rowPartOptions = bedRowPartOptions(session.moduleCell, rowPart.value, !clearInvalidSelections);
            ...
            const inletOptions = bedRolePartOptions(session.moduleCell, "input", inletValue, templateSelect.value, rowPart.value, !clearInvalidSelections);
            ...
            setPartSelectOptions(rowPart, rowPartOptions, rowPartOptions.some(function (part) { return part.id === rowPart.value; }) ? rowPart.value : (rowPartOptions[0] && rowPartOptions[0].id || ""));
            setPartSelectOptions(emitterPart, emitterOptions, emitterOptions.some(function (part) { return part.id === emitterPart.value; }) ? emitterPart.value : (emitterOptions[0] && emitterOptions[0].id || ""));
            ...
            setPartSelectOptions(rowTakeoffPart, rowTakeoffOptions, rowTakeoffOptions.some(function (part) { return part.id === rowTakeoffPart.value; }) ? rowTakeoffPart.value : (rowTakeoffOptions[0] && rowTakeoffOptions[0].id || ""));
            setPartSelectOptions(rowEndCapPart, rowEndCapOptions, rowEndCapOptions.some(function (part) { return part.id === rowEndCapPart.value; }) ? rowEndCapPart.value : (rowEndCapOptions[0] && rowEndCapOptions[0].id || ""));
            ...
            setPartSelectOptions(outletPart, outletLocked ? preservePartSelectOption(session.moduleCell, outletOptions, outletValue) : outletOptions, outletLocked ? outletValue : (outletOptions.some(function (part) { return part.id === outletValue; }) ? outletValue : ""));
            const selfEmitting = isSelfEmittingRowPart(partById(draft.catalog, rowPart.value));
            setTemplateFieldVisible(emitterPart, !selfEmitting);
            spacing.disabled = selfEmitting;
            if (selfEmitting) spacing.value = String(finiteNumber(partById(draft.catalog, rowPart.value) && partById(draft.catalog, rowPart.value).specs && partById(draft.catalog, rowPart.value).specs.emitterSpacingIn, 12));
        ...
        templateSelect.addEventListener("change", function () {
            const templateDef = bedTemplateById(templateSelect.value);
            const catalog = readCatalog(session.moduleCell);
            orientation.value = normalizeBedRowOrientation("", templateDef);
            rows.value = templateDef.defaultRows || 1;
            rowPart.value = templateDefaultRowPartId(catalog, templateDef);
            emitterPart.value = templateDefaultEmitterPartId(catalog, templateDef, rowPart.value);
            syncRowSpacingFromRows();
            commitChangedSelect(true);
        });
        orientation.addEventListener("change", function () { syncRowSpacingFromRows(); commitChangedSelect(false); });
        rowPart.addEventListener("change", function () { emitterPart.value = templateDefaultEmitterPartId(readCatalog(session.moduleCell), bedTemplateById(templateSelect.value), rowPart.value); commitChangedSelect(true); });
    ...
    function renderPortBadge(session, cell, role, index) {
        ...
        badge.title = (role === "input" ? "Inlet" : "Outlet") + " " + (index + 1) + visual.titleSuffix + " (" + label + ")";
    ...
    function portVisualRoleForCell(moduleCell, cell, role) {
        return isReversibleFittingCell(moduleCell, cell) && isPartCellFlipped(cell) ? (role === "input" ? "output" : "input") : role;
    }
    ...
    function renderZoneManager(container, moduleCell, state, session) {
        ...
        controls.appendChild(button("Close", hideDialog, "neutral"));
        container.appendChild(controls);
    }
    ...
    function styleHudOutlineButton(b, color) {
        applyIrrigationButtonStyle(b, color === HUD_OUTLINE_BLUE ? "open" : (color === HUD_OUTLINE_GREEN ? "add" : (color === HUD_OUTLINE_RED ? "danger" : "neutral")), { compact: true });
    ...
    function appendLocalAssemblyFoldActions(session, hud, selected) {
        if (!graph.foldCells) return null;
        const assemblies = selectedFoldableAssemblies(selected);
        if (!assemblies.length) return null;
        const collapsedCount = assemblies.filter(isAssemblyCollapsed).length;
        const group = hudActions();
        group.className = "trellis-irrigation-assembly-fold-toggle";
        const plural = assemblies.length === 1 ? "Assembly" : "Assemblies";
        if (collapsedCount < assemblies.length) group.appendChild(button("Collapse " + plural, function () { setSelectedAssembliesCollapsed(session, assemblies, true); }));
        if (collapsedCount > 0) group.appendChild(button("Expand " + plural, function () { setSelectedAssembliesCollapsed(session, assemblies, false); }));
        return appendHudActionSection(hud, "Assemblies", group);
    }

    function selectedFoldableAssemblies(selected) {
        const seen = new Set();
        const out = [];
        (selected || []).forEach(function (cell) {
            const assembly = isCenterStableFoldAssembly(cell) ? cell : findAssemblyAncestor(cell);
            if (!isCenterStableFoldAssembly(assembly)) return;
            const id = getCellId(assembly);
            if (id && seen.has(id)) return;
            if (id) seen.add(id);
            out.push(assembly);
    ...
    function isAssemblyCollapsed(assembly) {
        if (!assembly) return false;
        if (graph.isCellCollapsed) return !!graph.isCellCollapsed(assembly);
        if (model.isCollapsed) return !!model.isCollapsed(assembly);
        return !!assembly.collapsed;
    }

    function setSelectedAssembliesCollapsed(session, assemblies, collapsed) {
        if (!assemblies || !assemblies.length || !graph.foldCells) return;
        runIrrigationEdit(collapsed ? "collapseIrrigationAssemblies" : "expandIrrigationAssemblies", function () { graph.foldCells(!!collapsed, false, assemblies); });
        renderIrrigationMode(session);
    }
    ...
    function appendHudDangerAction(hud, label, fn) {
        ...
        danger.style.background = "#fff";
        danger.style.color = "#b91c1c";
    ...
    function deriveAssemblyPaths(moduleCell) {
        ...
        collectDescendants(moduleCell, function (cell) { return isAssembly(cell) && assemblyType(cell) === "bed"; }).forEach(function (bedEndpoint) {
            ...
            const pipeSegments = pipeEdges.map(function (edge) { return { edgeId: getCellId(edge) || "", pipePartId: getCellAttr(edge, ATTRS.PIPE_PART_ID, ""), partState: partStateForCell(edge), lengthFt: measuredEdgeLengthFeet(edge) }; }).filter(function (segment) { return !!segment.pipePartId; });
